...
Debian packaging for Node.js 22: monolithic `nodejs` replacement packages used by the [Dockershelf node-pipeline](../node-pipeline).
...
| Path | Purpose |
|------|---------|
| `node/` | Upstream Node.js git submodule (`v22.x` branch) |
